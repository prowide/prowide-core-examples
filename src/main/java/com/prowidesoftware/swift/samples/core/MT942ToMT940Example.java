...
public class MT942ToMT940Example {
	...
	public static void main(String[] args) {
		 ...
		 */
		MT942 interimStatement1  = MT942.parse("{1:F01AAAAAEADAXXX0000000000}{2:I942BBBBOMRXXXXXN}{4:\n" +
				":20:REF1\n" +
				":25:123456789\n" +
				":28C:1/2\n" +
				":34F:EUR0,\n" +
		 ...
		 */
		MT942 interimStatement2 = MT942.parse("{1:F01AAAAAEADAXXX0000000000}{2:I942BBBBOMRXXXXXN}{4:\n" +
				":20:REF2\n" +
				":25:123456789\n" +
				":28C:2/2\n" +
				":34F:EUR0,\n" +
	...
	/**
	 * Iterates the MT942 statements copying the transaction lines into the MT940 and computing the final balance
	 */
	private static BigDecimal addStatementLines(MT940 mt, List<MT942> interimStatements, BigDecimal openingAmount) {
	 ...
	 */
	private static BigDecimal addStatementLines(MT940 mt, MT942 interimStatement, BigDecimal openingAmount) {
		BigDecimal balance = openingAmount;
